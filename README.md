...
### 5. Active 2040 Profile Ventilation & Thermal Management
* **Internal Airflow Ducts:** Utilizes the hollow channels of the 2040 aluminum extrusions as structural cooling ducts to route continuous airflow around the internal electronics bay.
* **Integrated 2040 Fan Mount:** Houses an active cooling fan seamlessly inside the base profile, exhausting heat generated by the high-current NEMA 23 motors and TMC2209 driver heatsinks.
* **Thermal Stability:** Prevents thermal throttling on the Raspberry Pi during sustained vision processing tasks and keeps stepper driver temperatures well within safe operating limits during high-duty pick-and-place cycles.
* <img width="1559" height="1009" alt="ChatGPT Image Aug 16, 2026, 04_07_19 PM" src="https://github.com/user-attachments/assets/eca51ecd-71ce-490e-8313-e790b4425707" />
